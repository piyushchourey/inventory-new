          ...
          <div class="panel panel-success panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="<?php echo base_url('images/admin/is-user.png'); ?>" alt="" />
                  </div>
                  <div class="col-xs-8">
          ...
          <div class="panel panel-danger panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="<?php echo base_url(); ?>images/admin/is-document.png" alt="" />
                  </div>
                  <div class="col-xs-8">
          ...
          <div class="panel panel-dark panel-stat">
            <div class="panel-heading">
              ...
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="<?php echo base_url(); ?>images/admin/is-money.png" alt="" />
                  </div>
                  <div class="col-xs-8">
