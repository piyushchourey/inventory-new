             	...
             	<div class="row">
                    <div class="col-sm-5">
                      <div class="form-group no_margin">
                        <select name="category_id" class="form-control category" main="1">
                    ...
                    <div class="col-md-1">
                      <button type="button" class="btn btn-success subcat btn-sm" main="0"><i class="fa fa-arrow-down "></i></button>
                    </div>
              </div><!-- row -->
              <div class="dynamicSubcat" style="padding-bottom: 8px;">
              </div>
				 ...
				 <div class="col-sm-2">
                    <div class="form-group no_margin">
                      ...
                      <select class="form-control" name="tax" id="tax">
						...
						<?php if(!empty($all_tax) && !empty($all_tax[0]))
						{
							foreach($all_tax as $at)
								echo '<option value="'.$at['gst'].'">'.$at['name']." - ".$at['gst'].'%</option>';
						}
						?>
					  </select>
                    </div>
