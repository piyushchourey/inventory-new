...
class OAuth2_Provider_Linkedin extends OAuth2_Provider {
  ...
  public function get_user_info(OAuth2_Token_Access $token) {
    ...
    public function get_user_connections(OAuth2_Token_Access $token) {
     $url_profile = 'https://api.linkedin.com/v1/people/~/connections?format=json&' . http_build_query(array(
                'oauth2_access_token' => $token->access_token,
    ));
    $user = json_encode(file_get_contents($url_profile), true);
